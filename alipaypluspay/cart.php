...
<?php
    ...
    try{
        ...
        if ($last_id == 0) {
            ...
            $url = Tools::getShopDomainSsl(true, true).__PS_BASE_URI__.'index.php?fc=module&module=alipaypluspay&controller=confirmation&id_cart='.$_GET["cart_id"].'&id_module='.$module_id.'&id_order='.$last_id.'&key='.$_GET["customer"].'';
            echo $url;
        }
    }
    catch (Exception $e){
